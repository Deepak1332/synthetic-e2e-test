...
const config = {
  params: {
    //url: 'https://www.betking.com/sports/s',
  },

  playwrightOptions: {
    /* This is the location where all test cases are present. */
    testDir: './Users/deepakvyas/Downloads/elastic/synthetics-demo/betKing/demo.journey.js',
    ...
    use: {
      ...
      baseURL: 'https://www.betking.com/sports/s',
